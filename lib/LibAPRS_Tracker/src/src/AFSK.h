...
//AHE - Modiification
#define LED_TX_INIT() do {}while(0) //LED_DDR |= _BV(1); } while (0)
#define LED_TX_ON()   do {}while(0) //LED_PORT |= _BV(1); } while (0)
#define LED_TX_OFF()  do {}while(0) //LED_PORT &= ~_BV(1); } while (0)
